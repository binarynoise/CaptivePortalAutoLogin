...
import de.binarynoise.captiveportalautologin.server.routes.stats.Comparators.toNullable
    ...
    route("log/") {
        get {
            val columnDefinitions: DataFrame<ColumnDefinition> = dataFrameOf(
                ...
                ColumnDefinition("timestamp", "Timestamp", Comparators.RegularComparator.toNullable()),
